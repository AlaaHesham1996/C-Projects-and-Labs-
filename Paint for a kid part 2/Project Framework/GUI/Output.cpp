...
void Output::CreateDrawToolBar() const
{
	...
	MenuItemImages[ITM_CHNG_BK_CLR] = "images\\MenuItems\\Menu_CHNG_BK_CLR.jpg";
	MenuItemImages[ITM_DEL] = "images\\MenuItems\\Menu_DEL.jpg";
	MenuItemImages[ITM_MOVE] = "images\\MenuItems\\Menu_COPY_Paste.jpg";
	MenuItemImages[ITM_RESIZE] = "images\\MenuItems\\Menu_Move.jpg";
	...
	MenuItemImages[ITM_BRNG_FRNT] = "images\\MenuItems\\Menu_BRNG_FRNT.jpg";
	MenuItemImages[ITM_SAVE] = "images\\MenuItems\\Menu_SAVE.jpg";
	MenuItemImages[ITM_LOAD] = "images\\MenuItems\\Menu_LOAD.jpg";
	MenuItemImages[ITM_TO_PLAY] = "images\\MenuItems\\Menu_SWITCH.jpg";
...
void Output::CreatePlayToolBar() const
{
  ...
  //----------------------------------------------------------------**
	...
	MenuItemImages[ITM_PICK_AND_HIDE] = "images\\MenuItems\\Menu_PICK_AND_HIDE.jpg";
	MenuItemImages[ITM_TO_DRAW] = "images\\MenuItems\\Menu_SWITCH.jpg";
...
void Output::DrawCirc(Point P1, int P2, GfxInfo RectGfxInfo, bool selected) const
{
	color DrawingClr;
	if(selected)	
		DrawingClr = UI.HighlightColor; //Figure should be drawn highlighted
	...
	pWind->DrawCircle(P1.x,P1.y,P2,style);
